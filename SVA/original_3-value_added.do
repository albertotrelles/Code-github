...
clear all
*cd "/Users/razarate/Dropbox/COARSuperior/Data/Input/ValueAddedFile/ECE"
cd "/Users/razarate/Dropbox/COARSuperior/Data"
*global code "/home/razarate/projects/def-razarate/razarate/COARSuperior/code"
*cd "/home/razarate/projects/def-razarate/razarate/COARSuperior/data"
*cd "/Users/razarate/Downloads"

*log using "$code/2a-value_added", replace
...
*global outcomes "$enrollment admi_priv admi_pub admi_priv_top10 admi_pub_top10 adm_priv_ord adm_priv_extraord admi_priv_top10_ord admi_priv_top10_ext"

*Calculating Value Added at the School and Year Level
*-------------------------------------------------------------------------------------
use va_data, clear
...
cap drop students
gen students=1
cap drop students_2015
gen students_2015=1 if year==2015
cap drop students_2016
gen students_2016=1 if year==2016

save value_added_students, replace

use value_added_students, clear
keep schoolid va_1_* va_15_* va_16_* students students_2015 students_2016
collapse (sum) students students_2015 students_2016 (mean) va_1_* va_15_* va_16_*, by(schoolid)
drop if students_2015==0 | students_2016==0

foreach y of global outcomes{
	reg va_16_`y' va_15_`y' [aw=students]
	predict va_2_`y', xb	
}
save value_added_schools, replace
